...
client.on('ready', async () => {
 ...
 client.user.setActivity(`Silinmemiz`, { type:'WATCHING' })
  
  console.log("Silinmemiz.")
});
          ...
          try {
            if (!msg.member.permissions.has("BAN_MEMBERS")) {
                  msg.delete();
                      ...
                      return msg.reply('Hey! Küfür etmemelisin.').then(nordx => nordx.delete({timeout: 5000}))
            }              
          } catch(err) {
            console.log(err);
          }
          ...
          try {
            if (!msg.member.permissions.has("BAN_MEMBERS")) {
                  msg.delete();
                      ...
                      return msg.reply('Yakaladın krsm! Küfür Yasak.').then(nordx => nordx.delete({timeout: 5000}))
            }              
          } catch(err) {
            console.log(err);
          }
...
client.on("guildMemberAdd", member => {
  ...
  moment.locale("tr")
   ...
   var rol = member.guild.roles.cache.get("786234806333079582") //Cezalı Rol İD
   var kayıtsız = member.guild.roles.cache.get("786234805599600660") //Alınacak Rol İD
...
client.channels.get('792479356873211924').join()
})
